...
First I need to install the package I need
...
Make a input vector of our numeric quantity of interest i.e. fold change values and make sure it has ENTREZ gene name associated with it.
```{r}
...
What is in our result? We can use the `attributes()` function to see what is returned here.
